...
/**
 * PitObject class that extends {@link WorldObject} class.
 */
public class PitObject extends WorldObject {
    ...
    /**
     * PitObject constructor with two parameters
     * @param positionX the x coordinate
     * @param positionY the y coordinate
     */
    public PitObject(int positionX, int positionY) {
     ...
     * the distance to the closest corner of the pit.
     ...
     * @param robot the robot in the world
     * @param cornerPosition a pit corner position
     * @return the distance to the closest corner in number of steps
     */
